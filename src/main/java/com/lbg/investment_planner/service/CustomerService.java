...
public class CustomerService {
    ...
    public List<InvestmentSuggestions> getSuggestionsByGrowPercentage(Integer growPercentage) {return customerDao.getSuggestionsByGrowPercentage(growPercentage);
    }
}
